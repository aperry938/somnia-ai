            ...
            <div className="max-w-2xl mx-auto mb-6">
                <div className="flex bg-day-card-bg/50 dark:bg-night-card-bg/50 backdrop-blur-sm rounded-xl p-1 border border-day-border dark:border-night-border">
                    <button
                        ...
                        className={`flex-1 py-3 px-4 min-h-[48px] rounded-lg font-medium transition-all duration-300 flex flex-col items-center justify-center ${activeTab === 'dreams'
                    ...
                    >
                        {!userIsPremium && (
                            <span className="mb-0.5 inline-flex items-center gap-0.5 text-[8px] bg-gradient-to-r from-amber-500 to-orange-500 text-white px-1 py-0.5 rounded-full font-medium leading-none">
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 px-4 min-h-[48px] rounded-lg font-medium transition-all duration-300 flex flex-col items-center justify-center ${activeTab === 'analysis'
                            ? 'bg-day-accent dark:bg-night-accent text-white shadow-lg'
                            : 'text-day-text-secondary dark:text-night-text-secondary hover:bg-white/10 dark:hover:bg-black/10'
                            }`}
                    >
