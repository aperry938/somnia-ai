            ...
            <div className="flex overflow-x-auto gap-2 pb-2 scrollbar-hide" role="tablist" aria-label="Insights categories">
                {TABS.map(tab => (
                    <button
                        ...
                        className={`px-4 py-2 min-h-[44px] rounded-full text-sm whitespace-nowrap transition-all flex items-center justify-center gap-1.5 ${activeTab === tab
                    ...
                    >
                        {tab}
                        {!userIsPremium && (
                            <span className="inline-flex items-center gap-0.5 text-[8px] bg-gradient-to-r from-amber-500 to-orange-500 text-white px-1 py-0.5 rounded-full font-medium">
