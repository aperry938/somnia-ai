...
const slides = [
    {
        ...
        description: 'Your complete sleep wellness ecosystem—from soothing sounds and guided breathwork to intelligent dream analysis. Where science meets the art of restful sleep.',
        icon: (
