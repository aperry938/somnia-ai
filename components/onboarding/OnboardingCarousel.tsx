...
const slides = [
    {
        ...
        description: 'Your complete sleep wellness ecosystem. Soothing sounds and guided breathwork designed for deeper rest and clearer mornings. Where science meets the art of restful sleep.',
        icon: (
