...
export const BottomNav: React.FC<BottomNavProps> = ({ currentPage, setCurrentPage }) => {
    ...
    const navItems = [
        ...
        { page: 'chronicle' as Page, label: 'Chronicle', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v11.494m-9-5.747h18" /></svg>, badge: unreadCount > 0 ? unreadCount : undefined },
