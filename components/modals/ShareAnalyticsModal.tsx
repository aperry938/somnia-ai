...
const CARD_TYPES: { id: AnalyticsCardType; label: string; description: string; icon: string }[] = [
    { id: 'weekly-wrap', label: 'Weekly Wrap', description: 'Dreams, quality & themes', icon: '📊' },
    { id: 'dream-journey', label: 'Dream Journey', description: 'Level & progress', icon: '🚀' },
    { id: 'mood-insights', label: 'Mood Insights', description: 'Emotional patterns', icon: '🎭' },
    { id: 'sleep-quality', label: 'Sleep Score', description: 'Quality rating', icon: '😴' },
];
