...
export const LevelGuideModal: React.FC<LevelGuideModalProps> = ({ isOpen, onClose, currentLevel, totalDreams }) => {
    ...
    return (
        <div
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center px-4 pt-4 pb-[calc(6.5rem+var(--safe-area-inset-bottom))] sm:pb-4"
            onClick={onClose}
            role="dialog"
            aria-modal="true"
                            ...
                            >
                                <div className="flex items-center justify-between mb-1">
                                    ...
                                    {isUnlocked ? (
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" role="img">
                                            <title>Locked</title>
