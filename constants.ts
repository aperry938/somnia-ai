...
export const SOUNDSCAPES: Soundscape[] = [
    ...
    // NATURE SOUNDSCAPES
    { id: 'gentle_rain', name: 'Gentle Rain', type: 'synthetic', params: { type: 'rain' }, isPremium: false, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" })), description: "Soft, consistent rainfall creates a cocoon of calm that naturally slows brain activity for restful sleep." },
    { id: 'ocean_waves', name: 'Ocean Waves', type: 'synthetic', params: { type: 'ocean' }, isPremium: false, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 8h16M4 16h16" })), description: "Rhythmic ocean waves sync with your breath cycle. The predictable pattern activates the parasympathetic nervous system." },
    { id: 'fireplace', name: 'Fireplace', type: 'synthetic', params: { type: 'fireplace' }, isPremium: false, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.657 7.343A8 8 0 0117.657 18.657z" })), description: "Warm, crackling fire sounds trigger feelings of safety and comfort, lowering cortisol and promoting calm." },
