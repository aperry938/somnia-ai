...
export const SOUNDSCAPES: Soundscape[] = [
    ...
    { id: 'pink_noise', name: 'Pink Noise', type: 'noise', params: { type: 'pink' }, isPremium: false, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 8h16M4 16h16" }), React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M8 4l4 4 4-4" }), React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M8 12l4 4 4-4" })), description: "Deeper than white noise, resembling steady rain, can increase deep sleep time." },
    { id: 'brown_noise', name: 'Brown Noise', type: 'noise', params: { type: 'brown' }, isPremium: false, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M3 7v10h18V7M5 7L12 13L19 7" })), description: "Lowest frequencies, like a strong waterfall, excellent for deep relaxation." },
    { id: 'gentle_rain', name: 'Gentle Rain', type: 'file', params: { src: 'https://storage.googleapis.com/web-dev-assets/rain-sound.mp3' }, isPremium: false, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" })), description: "A steady, calming rainfall to wash away stress and help you drift off." },
    { id: 'ocean_waves', name: 'Ocean Waves', type: 'file', params: { src: 'https://storage.googleapis.com/web-dev-assets/ocean-waves.mp3' }, isPremium: false, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 8h16M4 16h16" })), description: "The rhythmic ebb and flow of ocean waves crashing on a distant shore." },
    ...
    { id: 'delta_waves', name: 'Delta Waves', type: 'binaural', params: { base: 100, diff: 3 }, isPremium: true, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M3.055 11H5a2 2 0 012 2v1a2 2 0 01-2 2H3.055a1 1 0 01-.707-1.707l1.414-1.414a1 1 0 010-1.414l-1.414-1.414A1 1 0 013.055 11z" }), React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M20.945 11H19a2 2 0 00-2 2v1a2 2 0 002 2h1.945a1 1 0 00.707-1.707l-1.414-1.414a1 1 0 000-1.414l1.414-1.414a1 1 0 00-.707-1.707z" })), description: "Binaural beats (1-4 Hz) associated with the deepest stages of sleep." },
    { id: 'theta_waves', name: 'Theta Waves', type: 'binaural', params: { base: 150, diff: 6 }, isPremium: true, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M17 14v6m-5-12v12m-5-6v6" })), description: "Binaural beats (4-8 Hz) linked to REM sleep, meditation, and creativity." },
    { id: 'alpha_waves', name: 'Alpha Waves', type: 'binaural', params: { base: 200, diff: 10 }, isPremium: true, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" })), description: "Binaural beats (8-12 Hz) for quiet, wakeful relaxation and stress reduction." },
];
