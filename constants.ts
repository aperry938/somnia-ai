...
export const SOUNDSCAPES: Soundscape[] = [
    ...
    { id: 'gentle_rain', name: 'Glass Rain', type: 'synthetic', params: { type: 'rain' }, isPremium: true, icon: React.createElement('svg', iconProps, React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" })), description: "Prismatic granular synthesis. Each droplet is a tiny glass bead through 3 resonant filters. Distinct, rhythmic, and musical." },
